...
# Run this to test the server and get the message
# Decryption key: ```c1X5gAIm3ZLMIBgqfH5Rmq```
# Secret: ```IH8dYSE6DV1-G30DFgQ1QSgcBBwqDA==```
# Message: ```CNETF{D0MA1N_FR0NT1NG}```
...
def main():
    ...
    if op == 'D':
        ...
        h1.request("GET", secret_url, headers={"Host" : "e343t4o5y.malwa.re.local"})
        r1 = h1.getresponse()
